...
abstract public class Command {
	...
	abstract public boolean execute(Game game) throws CommandParseException, CommandExecuteException;
	
	abstract public Command parse(String[] commandWords) throws CommandParseException, CommandExecuteException;
